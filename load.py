...
UserRoles.create(user=me,role=participant_role)
me=User.create(email='gregc@civicresource.com', password='gregc@civicresource.com',first_name='Gregory G. Curtin. Ph.D.',last_name='Curtin',affiliation='Civic Resource Group')
UserRoles.create(user=me,role=participant_role)
me=User.create(email='lrp929@gmail.com', password='lrp929@gmail.com',first_name='Lilia',last_name='Da Silva',affiliation='')
UserRoles.create(user=me,role=participant_role)
me=User.create(email='fdewindt@aeongroupllc.com', password='fdewindt@aeongroupllc.com',first_name='Frank',last_name='de Windt',affiliation='Aeon Group. LLC')
UserRoles.create(user=me,role=participant_role)
...
UserRoles.create(user=me,role=participant_role)
me=User.create(email='brian@gimbal.com', password='brian@gimbal.com',first_name='Brian',last_name='Dunphy',affiliation='Gimbal. Inc.')
UserRoles.create(user=me,role=participant_role)
...
UserRoles.create(user=me,role=participant_role)
me=User.create(email='rocco@gimbal.com', password='rocco@gimbal.com',first_name='Rocco',last_name='Fabiano',affiliation='Gimbal. Inc.')
UserRoles.create(user=me,role=participant_role)
...
UserRoles.create(user=me,role=participant_role)
me=User.create(email='aleks@gisvolunteers.org', password='aleks@gisvolunteers.org',first_name='Alex',last_name='Hammer-Barulich',affiliation='Gladstein. Neandross & Associates')
UserRoles.create(user=me,role=participant_role)
...
UserRoles.create(user=me,role=participant_role)
me=User.create(email='jjeon@gimbal.com', password='jjeon@gimbal.com',first_name='James',last_name='Jeon',affiliation='Gimbal. Inc.')
UserRoles.create(user=me,role=participant_role)
...
UserRoles.create(user=me,role=participant_role)
me=User.create(email='rsmith@martinoutdoormedia.net', password='rsmith@martinoutdoormedia.net',first_name='Randall',last_name='Smith',affiliation='Martin Outdoor Media. LLC')
UserRoles.create(user=me,role=participant_role)
